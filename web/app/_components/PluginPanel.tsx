...
/** A plugin as a field of its own colour. The link is the whole panel, which is why the
 *  stylesheet has to out-specify the generic anchor rule to keep the on-colour ink. */
